...
class TransferModel{
    ...
    getAllTransferModel(user_id) {
        return new Promise((resolve, reject) => {
            ...
            connection.query(sqlQuery, [user_id, user_id], (error, result) => {
                if (error) {
                    reject(error)
                }
                resolve(result)
